...
// مصفوفة المنتجات الابتدائية (أسلوب طالب)
$products = [
...
// مصفوفة نموذج موحّدة لملء الحقول
$form = [
  "name" => "",
  "description" => "",
  "price" => "",
...
if ($_SERVER["REQUEST_METHOD"]==="POST" && isset($_POST["save_action"])) {
  ...
  // صورة: اختيارية، إن وُجدت نسمح بأي URL بسيط
  if ($form["image"]!=="") {
    // فحص بسيط جدًا (اختياري)
...
////////////////////////////////////////////////////
// Part 4: Prefill form for EDIT (GET only)       //
// مهم: لا نعبّي من edit_id أثناء POST            //
////////////////////////////////////////////////////
...
<body class="container py-4">
  ...
  <script>
  // تمرير بيانات الصف المحذوف إلى الـModal
